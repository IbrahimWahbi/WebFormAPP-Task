<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddEmployee.aspx.cs" Inherits="WebFormAPP.EmployeesContainer.AddEmployee" Title="Add New Employee" %>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-offset-md-2 col-md-10">
                            <asp:Button runat="server" OnClick="AddNewEmployee" Text="Add Employee" CssClass="btn btn-outline-dark" />
                        </div>
                    </div>
                </div>
